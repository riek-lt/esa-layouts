...
import L_GB_3p from './gb-2p.vue';
import L_GBA_1p from './gba-1p.vue';
import L_GBA_2p from './gba-2p.vue';
import L_16x9_2p_c from './16x9-2p-c.vue';

export { L_4x3_1p, L_4x3_2p, L_4x3_3p, L_4x3_4p, L_16x9_1p, L_16x9_2p, L_16x9_3p, L_3DS_1p, L_DS_1p, L_GB_1p, L_GBA_1p, L_16x9_1p_LargeCam, L_4x3_1p_LargeCam, L_3DSV_1p, L_3DS_2p, L_DS_2p, L_DSV_1p, L_GB_2p, L_GB_3p, L_GBA_2p, L_16x9_2p_c};

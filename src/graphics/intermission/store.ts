import type { Bids, Commentators, DonationReader, MediaBox, MusicData, Prizes, UpcomingRunID, DonationTotal } from '@esa-layouts/types/schemas'; // eslint-disable-line object-curly-newline, max-len

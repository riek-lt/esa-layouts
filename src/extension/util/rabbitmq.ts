...
import { RabbitMQ as RabbitMQTypes } from '@esa-layouts/types';
...
const { useTestData, rabbitmq } = nodecgGetter().bundleConfig;
const exchange = 'cg';
const event = getCurrentEventShort();

// eslint-disable-next-line import/prefer-default-export
export const mq = new RabbitMQ(nodecgGetter(), useTestData, {
  config: rabbitmq,
  exchange,
  event,
  listenTopics: [

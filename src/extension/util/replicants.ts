...
export const taskmasterContestantList = nodecg().Replicant<TaskMasterContestantList>('taskmasterContestantList', { defaultValue: [] }) as unknown as NodeCGTypes.ServerReplicantWithSchemaDefault<TaskMasterContestantList>;
